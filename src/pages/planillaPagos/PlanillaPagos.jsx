...
const historiaLabel = (historia) => historia?.id
  ? `Historia #${historia.id} · ${historia.diagnostico_medico?.trim() || 'Sin diagnóstico registrado'}`
