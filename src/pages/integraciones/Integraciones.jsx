    ...
    <Modal open={googleDetailsOpen} title="Detalles de Google Calendar" subtitle="Configuración y estado de la sincronización" onClose={() => setGoogleDetailsOpen(false)} size="md" closeOnBackdrop closeOnEscape>
      <div className="grid gap-5">
        ...
        <dl className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-200 p-4"><dt className="text-xs font-black uppercase tracking-wide text-slate-400">Calendario</dt><dd className="mt-1 font-bold text-slate-800">{google?.calendarName || google?.calendarId || 'No disponible'}</dd></div>
